...
SELECT
    ...
    CASE 
        ...
        THEN 1 ELSE 0 
    END AS is_delay,
	YEAR(o.order_delivered_customer_date) AS deliver_year,
	MONTH(o.order_delivered_customer_date) AS deliver_month,
    r.review_score
FROM orders o
...
GROUP BY is_delay,deliver_year, deliver_month
